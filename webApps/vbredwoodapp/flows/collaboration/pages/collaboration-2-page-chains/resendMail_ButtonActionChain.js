define([
  ...
  class resendMail_ButtonActionChain extends ActionChain {
    ...
    async run(context, { event, originalEvent }) {
      const { $page, $flow, $application, $constants, $variables, $functions } = context;
            ...
            try {
        // const validateGroup = await $functions.validateGroup('emailvalidation_resend');
        ...
        const emaildlgResendClose = await Actions.callComponentMethod(context, {
          selector: '#emaildlg_resend',
          method: 'close',
        });
      }
    }
  ...
  return resendMail_ButtonActionChain;
});
